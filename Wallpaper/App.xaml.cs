...
namespace Wallpaper
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnFileActivated(FileActivatedEventArgs args)
        {
            ...
            foreach (StorageFile fileName in args.Files)
            {
                if (fileName.FileType == ".udt")
                {
                    string selectedDynamicThemeName = Path.GetFileNameWithoutExtension(fileName.Name);
